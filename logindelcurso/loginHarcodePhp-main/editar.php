...
if($_GET)
{
    if($_GET['editar'])
    {
        $cargarUsuario = "SELECT user_id,nombreCompleto,username,pass 
...
<main>
    ...
    <form method="post" action="editar.php">
        ...
        <input class="contenido_edit" type="hidden" name="idUsuario" value='<?php echo $datosCampos['user_id'];?>'>
        <label for="txt_nombre">Nombre</label>
        
        <input class="contenido_edit" type="text" name="nombre" value='<?php echo $datosCampos['nombreCompleto'];?>' id="txt_nombre"><br/>
        <label for="idUsuario">Usuario</label>
        
        <input class="contenido_edit" type="text" name="usuario"  value='<?php echo $datosCampos['username'];?>' id="idUsuario"><br/>
        <label for="passWord">Password</label>
        
        
        <input class="contenido_edit" type="passWord" name="clave"  value='<?php echo $datosCampos['pass'];?>' id="passWord"><br/>
